...
<script>
	function registration() {
		...
		if (today >= new Date(date)) {
			alert("투어날짜는 오늘 날짜이거나 과거일 수 없습니다");
			document.form1.date.focus();
			return;
		}
		if (starttime == "") {
				...
				<article class="box post">
					...
					<form action="insert" name="form1" method="post" enctype="multipart/form-data">
						<table>
							...
							<tr>
								<td colspan="2" align="center"><input type="hidden" ${dto.write }>
									<input type="hidden" ${dto.code }> 
									<input type="button" value="등록" onclick="registration()"> 
